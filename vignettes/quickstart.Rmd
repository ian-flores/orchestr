...
This loop is implemented by `graph_react()` and runs within a safety cap
...
All graph types (`graph_react()`, `graph_pipeline()`, `graph_supervisor()`)
...
`graph_react()` wraps a single agent in a graph that adds three things a bare
