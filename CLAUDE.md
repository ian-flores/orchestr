...
An R package for graph-based multi-agent workflow orchestration. Built on ellmer for LLM chat and optionally securer for sandboxed code execution.
...
- `R/convenience.R` -- react_graph(), pipeline_graph(), supervisor_graph()
...
- END sentinel = "__end__" string constant
